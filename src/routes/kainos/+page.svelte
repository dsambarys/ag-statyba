    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {#each data.pricingTiers as tier}
                <div class="bg-white p-8 rounded-lg shadow-lg border border-gray-100 hover:border-blue-500 transition-all">
                    <h3 class="text-2xl font-semibold mb-4">{tier.type}</h3>
                    ...
                    {#if tier.note}
                        <p class="text-sm text-gray-500 mb-6">{tier.note}</p>
                    {/if}
                    <button
        ...
        <div class="bg-gray-50 rounded-xl p-8 mb-16">
            <h2 class="text-2xl font-semibold mb-8 text-center">Papildoma informacija</h2>
        ...
        {#if showContactForm}
            <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
                <div class="bg-white rounded-lg p-8 max-w-lg w-full">
                    <h2 class="text-2xl font-semibold mb-4">Užsakyti projektą</h2>
